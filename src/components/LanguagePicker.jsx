  ...
  return (
    <div ref={ref} className={`relative ${className}`}>
      ...
      >
        ...
        <svg viewBox="0 0 24 24" className={`w-3 h-3 transition-transform ${open ? "rotate-180" : ""}`} fill="currentColor">
          <path d="M7.41 8.59 12 13.17l4.59-4.58L18 10l-6 6-6-6-1.41 1.41Z" />
        </svg>
      </button>

      {open && (
        <div className="absolute right-0 top-full mt-1 bg-base-100 border border-base-content/20 rounded-box shadow-xl z-50 w-64 max-h-80 overflow-y-auto">
          {LANGUAGES.map((l) => {
