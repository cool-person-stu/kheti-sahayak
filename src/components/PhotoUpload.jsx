  ...
  return (
    <div className="space-y-4">
      ...
      >
        ...
        <span className="text-sm text-base-content/60">Tap to take or choose a photo</span>
      </label>
      ...
      {photos.length === 0 && !preview && (
        <p className="text-sm text-base-content/50 text-center">
          No photos yet. Upload one to start building a record of this farmer's harvests.
        </p>
      )}
    </div>
  )
